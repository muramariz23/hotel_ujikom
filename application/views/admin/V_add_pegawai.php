...
<form action="<?php echo site_url('admin/Pegawai/AddPegawai'); ?>" method="post" enctype="multipart/form-data">
  ...
  <input type="text" name="txt_nama_pegawai" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Alamat</span>
  <input type="text" name="txt_alamat" class="form-control" placeholder="Alamat" aria-label="Username" aria-describedby="basic-addon1">
</div>
