...
<head>
	...
	<style type="text/css">
		...
		@font-face{
			font-family: "judul";
			src: url('<?php echo base_url('assets/font/Kanit-SemiBold.ttf') ?>');
		}
		@font-face{
			font-family: "hl";
			src: url('<?php echo base_url('assets/font/Kanit-Black.ttf') ?>');
		}
		@font-face{
			font-family: "subjudul";
			src: url('<?php echo base_url('assets/font/Kanit-Medium.ttf') ?>');
		}
		.judul{
			text-align: center;
...
<body>
  ...
  <div class="container-fluid">
    <img src="<?php echo base_url('assets/img/logo.png') ?>" class="navbar-brand logo">
