...
<form action="<?php echo site_url('pengguna/Pengguna/EditProfile'); ?>" method="post">
  ...
  <input type="text" name="txt_nama_pengguna" class="form-control" placeholder="Nama Pengguna" aria-label="Username" aria-describedby="basic-addon1" required value="<?php echo $detail['nama_pengguna'] ?>">
</div>

<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Email</span>
  <input type="text" name="txt_email" class="form-control" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" required value="<?php echo $detail['email'] ?>">
</div>

<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">No Telepon</span>
  <input type="text" name="txt_no_telepon" class="form-control" placeholder="Ex:08123*****" aria-label="Username" aria-describedby="basic-addon1" required value="<?php echo $detail['no_telepon'] ?>">
</div>
